...
function HeroSection() {
  return (
    <>
      <section className="self-center pt-20 flex text-foreground  min-w-full  mx-auto flex-col min-h-[65vh] md:min-h-[70vh] gap-10 px-6">
      ...
      <section className="md:min-h-[10vh] min-w-screen">
        <Line />
      </section>
    </>
  );
